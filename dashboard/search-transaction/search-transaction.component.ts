...
export class SearchTransactionComponent implements OnInit {
  ...
  columns: any[] = [
    ...
    { name: 'payerMobile', label: 'Payer Mobile' },
    { name: 'payeeMobile', label: 'Payee Mobile' },
    { name: 'status', label: 'Status' }
  ];

  columnsToExport = [
    'txnId', 'type', 'displayMessage', 'currencyCode', 'amount', 'rc', 'custRefNo', 'date',
    'cbsRefId', 'paymentMode', 'payerName', 'payerVPA', 'payerWallet', 'payeeName', 'payeeVPA', 'payeeWallet', 'payerMobile', 'payeeMobile', 'status'
  ]
